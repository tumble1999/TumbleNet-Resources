    ...
    githubAPI("repos/" + username + "/" + repoName + "/releases", function(data) {
      ...
      //https://github.com/tumblegamer/TumbleCraft/releases/new
        ...
        $(releases).each(function() {
            text = text + "<tr><th><a href='" + this.html_url + "'>" + this.name + "</a></th><th>" + this.tag_name + "</th><th><a href='" + this.zipball_url + "'>Zip</a> - <a href='" + this.tarball_url + "'>Tar</a></th><th><a href='" + this.assets.browser_download_url + "'>Download</a>(" + this.assets.download_count + ")</th>";
        });
